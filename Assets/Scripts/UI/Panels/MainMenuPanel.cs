...
public class MainMenuUIPanel : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        generalStatsButton.onClick.AddListener(() => GameEventBus.Publish(new RequestOpenPopupEvent{targetPopup = PopupType.GeneralStats}));
    ...
    void OnDisable()
    {
        ...
        addHeartButton.onClick.AddListener(OpenRefillHeart);
        generalStatsButton.onClick.RemoveListener(() => GameEventBus.Publish(new RequestOpenPopupEvent{targetPopup = PopupType.GeneralStats}));
    ...
    {
       GameEventBus.Publish(new RequestOpenPopupEvent{targetPopup = PopupType.RefillHeart});
    }
