...
public class EndGamePanel : MonoBehaviour
{
    ...
    private LevelCompletedPanel levelCompleted;
    private LevelFailedPanel levelFailed;
    ...
    private void InitPanels()
    {
        if (levelCompleted == null) 
            levelCompleted = GetComponentInChildren<LevelCompletedPanel>(true);
            
        if (levelFailed == null) 
            levelFailed = GetComponentInChildren<LevelFailedPanel>(true);
    }
    ...
    {
        if(isWin) ShowLevelCompletedPanel();
        else ShowLevelFailedPanel();
    }
